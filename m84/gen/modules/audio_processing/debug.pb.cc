...
RuntimeSetting::RuntimeSetting(const RuntimeSetting& from)
  ...
  ::memcpy(&capture_pre_gain_, &from.capture_pre_gain_,
    static_cast<size_t>(reinterpret_cast<char*>(&capture_output_used_) -
    reinterpret_cast<char*>(&capture_pre_gain_)) + sizeof(capture_output_used_));
...
void RuntimeSetting::SharedCtor() {
  ...
  ::memset(&playout_audio_device_change_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&capture_output_used_) -
      reinterpret_cast<char*>(&playout_audio_device_change_)) + sizeof(capture_output_used_));
}
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (48 & 0xFF)) {
          _Internal::set_has_capture_output_used(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   bool, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_BOOL>(
                 input, &capture_output_used_)));
        } else {
          goto handle_unusual;
        }
        break;
...
void RuntimeSetting::SerializeWithCachedSizes(
  ...
  // optional bool capture_output_used = 6;
  if (cached_has_bits & 0x00000020u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBool(6, this->capture_output_used(), output);
  }
