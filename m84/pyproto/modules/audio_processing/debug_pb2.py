...
_PLAYOUTAUDIODEVICEINFO = _descriptor.Descriptor(
  name='PlayoutAudioDeviceInfo',
  full_name='webrtc.audioproc.PlayoutAudioDeviceInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='webrtc.audioproc.PlayoutAudioDeviceInfo.id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_volume', full_name='webrtc.audioproc.PlayoutAudioDeviceInfo.max_volume', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RUNTIMESETTING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='capture_fixed_post_gain', full_name='webrtc.audioproc.RuntimeSetting.capture_fixed_post_gain', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='playout_volume_change', full_name='webrtc.audioproc.RuntimeSetting.playout_volume_change', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='playout_audio_device_change', full_name='webrtc.audioproc.RuntimeSetting.playout_audio_device_change', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='capture_output_used', full_name='webrtc.audioproc.RuntimeSetting.capture_output_used', index=5,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RUNTIMESETTING.fields_by_name['playout_audio_device_change'].message_type = _PLAYOUTAUDIODEVICEINFO
...
DESCRIPTOR.message_types_by_name['PlayoutAudioDeviceInfo'] = _PLAYOUTAUDIODEVICEINFO
...
ReverseStream = _reflection.GeneratedProtocolMessageType('ReverseStream', (_message.Message,), {
...
PlayoutAudioDeviceInfo = _reflection.GeneratedProtocolMessageType('PlayoutAudioDeviceInfo', (_message.Message,), {
  'DESCRIPTOR' : _PLAYOUTAUDIODEVICEINFO,
  '__module__' : 'debug_pb2'
  # @@protoc_insertion_point(class_scope:webrtc.audioproc.PlayoutAudioDeviceInfo)
  })
_sym_db.RegisterMessage(PlayoutAudioDeviceInfo)

RuntimeSetting = _reflection.GeneratedProtocolMessageType('RuntimeSetting', (_message.Message,), {
